...
struct IMGUI_API ImGuiTabBar
{
	...
	ImGuiWindow*		Window; //I added this!
    ImGuiTabBar();
};
...
namespace ImGui
{
	...
	IMGUI_API const char*   LocalizeGetMsg(ImGuiLocKey key);
...
//#endif
    ...
    // Basic Accessors
	IMGUI_API ImGuiItemStatusFlags GetItemStatusFlags();
	IMGUI_API ImGuiItemFlags GetItemFlags();
	IMGUI_API ImGuiID       GetActiveID();
	IMGUI_API ImGuiID       GetFocusID();
	...
	IMGUI_API bool          IsActiveIdUsingNavDir(ImGuiDir dir);
	...
	IMGUI_API ImGuiID       GetCurrentFocusScope();
    ...
    // Tab Bars
	IMGUI_API ImGuiTabBar*  GetCurrentTabBar();
