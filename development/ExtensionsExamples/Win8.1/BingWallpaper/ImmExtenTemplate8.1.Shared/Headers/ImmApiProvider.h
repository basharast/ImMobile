...
enum class ImMobileOverrides {
	...
	IMM_OVERRIDE_DCENTER_SETTINGS, // Not implemented in 8.1
	IMM_OVERRIDE_DCENTER_CONTROLS, // Not implemented in 8.1
...
//__declspec(dllimport) void zipStorageFolder(StorageFolder^ folder, std::string outputZipPath, std::function<void(bool, std::string)> callback); 
